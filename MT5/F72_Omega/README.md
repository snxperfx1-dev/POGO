...
│  └─ Narrative/                — narrative engine (Phase 4)
│     ├─ LifeScore.mqh          — canonical _life formula (force/residual/retrace/progressing)
│     ├─ Alignment.mqh          — fractal stack agreement + cross-TF story label
